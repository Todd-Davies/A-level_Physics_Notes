...
\thispagestyle{empty}
Momentum is the quantity of motion of a moving body. It is measured as the
product of the mass and the velocity of the body.

The idea of momentum can be used to explain and predict the outcome of
collisions. It often comes up in questions about space too.


\section*{Equations to remember}
\label{sec:Equationstoremember}
The trickiest thing about momentum equations is remembering to take negative
values into account. If one object is travelling one way and another is
travelling the opposite way, then if they collide, the final momentum will be
equal to the first object's momentum take the second object's momentum.
